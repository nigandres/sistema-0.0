            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-tasks">
                                ...
                                <a href="">
                                    <div>
                                        <p>
                                            ...
                                            <span class="pull-right text-muted">Añade mas!</span>
                                        </p>
                                    </div>
                                </a>
                            </li> 
                        ...
                        <li class="divider"></li>
                        <li>
                            <a class="text-center" href="{{asset('/administracion/tareas')}}">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href=""><i class="fa fa-bar-chart-o fa-fw"></i> Escuela<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{asset('administracion/materias')}}">Materias</a>
                                </li>
                                <li>
                                    <a href="{{asset('administracion/tareas')}}">Tareas</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
