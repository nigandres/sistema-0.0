...
function obtieneOpciones(){
	...
	switch(opt.text){
		case "Libros":
            ...
            +'<input type="checkbox" name="fields[]" value="id_editorial"> <label>id_editorial</label><br>'
            +'<input type="checkbox" name="fields[]" value="id_categoria"> <label>id_categoria</label><br>'
            ...
            +'<select name="restriccion-ordenar" class="form-control">'
                ...
                +'<option value="id_editorial">Id Editorial</option>'
                +'<option value="id_categoria">Id Categoria</option>'
